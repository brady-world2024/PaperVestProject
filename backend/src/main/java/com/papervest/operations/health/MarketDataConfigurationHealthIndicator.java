...
public class MarketDataConfigurationHealthIndicator implements HealthIndicator {
	...
	public Health health() {
		...
		return Health.up()
				...
				.withDetail("quoteStaleGraceTtl", properties.quoteStaleGraceTtl().toString())
				.withDetail("historyCacheTtl", properties.historyCacheTtl().toString())
				.withDetail("historyStaleGraceTtl", properties.historyStaleGraceTtl().toString())
				.withDetail("searchCacheTtl", properties.searchCacheTtl().toString())
				.withDetail("searchStaleGraceTtl", properties.searchStaleGraceTtl().toString())
				.withDetail("allowPartialHomeResults", properties.allowPartialHomeResults())
